...
metadata["FileName"] = metadata["Bismark_GW_COV"].apply(lambda x: os.path.basename(str(x)))
...
if os.path.isfile(os.path.join(path_to_save_prep_metadata, "{}.{}.metadata.csv".format(data_name, sub_data_name))) == False:
    ...
    maindf["methylationCaller"] = "bismark"
...
bamBucket = RDSBucket( 
                        ...
                        bucketName = "lowdepth-gw-bismark-cov",
